...
**Status**: 4G.7 COMPLETE — all clusters extracted; subtitle_engine.py is a frozen pure re-export shim; compatibility policy documented; caller migration audit complete  
**Date**: 2026-05-22  
