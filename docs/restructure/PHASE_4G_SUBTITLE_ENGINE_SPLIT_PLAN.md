...
**Status**: 4G.6 SHIPPED — styles.py + srt_core.py + output_timeline.py + readability.py(full) + ass_core.py + text_transforms.py + transcription.py extracted; subtitle_engine.py is now a pure ~45-line re-export shim; 4G.7 pending  
**Date**: 2026-05-22  
