...
**Last updated**: 2026-05-22 (post Phase 4H.2; services/preview/session_service.py created; 4 session helpers + 4 state vars extracted from routes/render.py; routes/render.py reduced 1,205→1,150 lines)
...
Electron shell
  └── BrowserWindow → http://127.0.0.1:8000/
        └── FastAPI + Uvicorn (single process)
              ...
              ├── services/preview/ (Phase 4H.1–4H.2)
