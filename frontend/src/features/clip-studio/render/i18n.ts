...
const T = {
  EN: {
    ...
    cfgRecapPromptTitle: 'Switch to Recap mode?',
    cfgRecapPromptMsg: 'Recap recommends: 16:9 frame + AI narration enabled. Apply these, or keep your current settings?',
    cfgRecapApply: 'Apply recap defaults',
    cfgRecapKeep: 'Keep my settings',
    cfgBrowse: 'Browse',
    ...
    resExportBtn: 'Export…',
    resExportTitle: 'Export clips for publishing',
    resExportPlatform: 'Platform',
    resExportNone: 'No preset',
    resExportFolder: 'Folder',
    resExportMeta: 'Write .txt metadata (AI title + hashtags)',
    resExportRun: (n: number) => `Export ${n} clip${n !== 1 ? 's' : ''}`,
    resExportBusy: 'Exporting…',
    ...
    resFbLearned: 'Noted — AI Director learns from this for your next renders',
  ...
  VI: {
    ...
    cfgRecapPromptTitle: 'Chuyển sang chế độ Recap?',
    cfgRecapPromptMsg: 'Recap khuyến nghị: khung 16:9 + bật thuyết minh AI. Áp dụng, hay giữ cài đặt hiện tại?',
    cfgRecapApply: 'Áp dụng mặc định Recap',
    cfgRecapKeep: 'Giữ cài đặt của tôi',
    cfgBrowse: 'Chọn…',
    ...
    resExportBtn: 'Xuất file…',
    resExportTitle: 'Xuất clip để đăng',
    resExportPlatform: 'Nền tảng',
    resExportNone: 'Không preset',
    resExportFolder: 'Thư mục',
    resExportMeta: 'Ghi .txt metadata (tiêu đề AI + hashtag)',
    resExportRun: (n: number) => `Xuất ${n} clip`,
    resExportBusy: 'Đang xuất…',
    // P2.3 - AI copy pass
    ...
    resFbLearned: 'Đã ghi nhận — AI Director sẽ học từ đánh giá này cho các render sau',
