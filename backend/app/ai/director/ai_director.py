...
from app.ai.director.platform_context import (
    _attach_platform_context,
    _attach_platform_subtitle_context,
    _attach_platform_camera_context,
    _attach_platform_hook_context,
    _attach_platform_render_strategy,
    _attach_platform_strategy_influence,
    _attach_platform_quality_feedback,
)

from app.ai.director.creator_context import (
    _attach_creator_style,
    _append_style_explainability,
    _attach_creator_style_adaptation,
    _append_creator_style_adaptation_explainability,
    _attach_creator_knowledge,
    _append_creator_knowledge_explainability,
    _attach_creator_patterns,
    _append_creator_patterns_explainability,
    _attach_creator_retrieval,
    _append_creator_retrieval_explainability,
    _attach_adaptive_creator_intelligence,
    _append_adaptive_explainability,
    _attach_creator_feedback_intelligence,
    _append_feedback_explainability,
    _attach_creator_preset_evolution,
    _append_preset_evolution_explainability,
    _attach_creator_subtitle_preference,
    _attach_creator_camera_preference,
    _attach_creator_subtitle_influence,
    _attach_creator_preference_profile,
)
...
# _attach_platform_context, _attach_platform_subtitle_context,
# _attach_platform_camera_context, _attach_platform_hook_context,
# _attach_platform_render_strategy, _attach_platform_strategy_influence,
# _attach_platform_quality_feedback
# → moved to app.ai.director.platform_context (C-2)
