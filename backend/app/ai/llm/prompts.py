...
# ──────────────────────────────────────────────────────────────────────────
# Sprint 4.B — RenderPlan prompt (dual-mode alongside build_segment_prompt)
# ──────────────────────────────────────────────────────────────────────────
...
_USER_TEMPLATE_RP = """\
Build a RenderPlan from this transcript ({language}) — pick up to {output_count} clips
...
standalone moments. For each top-ranked hook:
  ...
  1. The hook itself is typically 2-10 seconds. Back the start up so the
     hook lands within the first 3 seconds of the clip — usually 5-15
     seconds of lead-in.
  2. Extend the end until the thought is complete and the payoff lands —
