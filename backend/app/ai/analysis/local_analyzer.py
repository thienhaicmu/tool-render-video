...
from app.ai.analysis.signals import AnalysisSignals, ClipSignal, EmotionSignal

try:
    from app.ai.analyzers.emotion_analyzer import analyze_pacing_emotion as _analyze_emotion
