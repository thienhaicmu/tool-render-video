...
# Sprint 6.D-3.6a: build_subject_path extracted to a dedicated module.
# Uses deferred imports for 4 symbols still resident here
# (_subject_to_crop_center, _apply_velocity_limiter,
# _required_lock_confirm_frames, build_subject_path_scene) — those
# imports happen inside the function body to break the load-time cycle.
# Re-exported so existing internal call sites (build_motion_path
# dispatcher) keep their bare references.
from app.services.motion_crop_path import build_subject_path
...
# Sprint 6.D-3.6a: `build_subject_path` → moved to
# app.services.motion_crop_path. Re-exported at top of this file.
# Note: build_subject_path_scene + _subject_to_crop_center +
# _apply_velocity_limiter + _required_lock_confirm_frames remain HERE
# for now — the new module uses deferred imports to call them.
