"""Motion-crop subject-path builder — CapCut-style Auto Reframe entry point.

Sprint 6.D-3.6a — extracted verbatim from motion_crop.py
...
from app.services.motion_crop_utils import clamp, _load_cascade, _gaussian_smooth_1d
