...
def prune_job_logs(logs_dir: Path, keep_last: int = 30, older_than_days: int = 10):
    ...
    if not log_dir.exists():
        return {"scanned": 0, "removed": 0, "keep_last": keep_last, "older_than_days": older_than_days}
