...
def test_narration_cleanup_none_uses_original_path(tmp_path):
    ...
    with patch("app.orchestration.render_pipeline.cleanup_audio_with_adapter") as cleanup:
...
def test_narration_cleanup_placeholder_falls_back_to_original(tmp_path):
    ...
    with patch("app.orchestration.render_pipeline._job_log") as job_log, \
         patch(
             "app.orchestration.render_pipeline.cleanup_audio_with_adapter",
...
def test_narration_cleanup_invalid_output_falls_back_to_original(tmp_path):
    ...
    ), patch("app.orchestration.render_pipeline._job_log"):
        result = _maybe_cleanup_narration_audio(
            str(original),
            payload,
            effective_channel="test",
...
def test_narration_cleanup_exception_falls_back_to_original(tmp_path):
    ...
    ), patch("app.orchestration.render_pipeline._job_log") as job_log:
        result = _maybe_cleanup_narration_audio(
            str(original),
            payload,
            effective_channel="test",
